    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-[hsl(222,47%,4%)/0.82]" />
          <div className="absolute inset-0 bg-gradient-to-r from-[hsl(222,47%,4%)] via-[hsl(222,47%,4%)/0.92] to-[hsl(222,47%,4%)/0.75]" />
        </div>

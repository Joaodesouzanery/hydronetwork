      ...
      <div className="container px-4 py-12 mx-auto max-w-5xl">
        ...
        <div className="space-y-8">
          <div className="text-center space-y-4">
            <div className="w-16 h-16 bg-violet-600 flex items-center justify-center text-white mx-auto">
              <QrCode className="w-8 h-8" />
            </div>
            <h1 className="text-4xl font-bold font-mono text-white">Manutenção via QR Code</h1>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {features.map((feature, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-none border border-white/10 p-6">
          ...
          {/* Benefits */}
          <div className="bg-white/5 backdrop-blur-sm rounded-none border border-white/10 p-8">

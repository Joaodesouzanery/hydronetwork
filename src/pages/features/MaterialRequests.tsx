      ...
      <div className="container px-4 py-12 mx-auto max-w-5xl">
        ...
        <div className="space-y-8">
          <div className="text-center space-y-4">
            <div className="w-16 h-16 bg-teal-600 flex items-center justify-center text-white mx-auto">
              <ClipboardList className="w-8 h-8" />
            </div>
            <h1 className="text-4xl font-bold font-mono text-white">Pedidos de Material</h1>

...
export {
  ...
  createLayer, removeLayer, getLayersByDiscipline, getAllLayers,
  addNode, removeNode, moveNode, getNode, getAllNodes, getNodesByLayer,
  addEdge, removeEdge, recalculateEdge, getConnectedEdges, getAllEdges, getEdgesByLayer,
